...
class MCStrategy(IStrategy):
    ...
    wt_overbought_l1 = RealParameter(low=0, high=99, default=53, space='sell', optimize=True, load=True)
    wt_overbought_l2 = 60
    wt_overbought_l3 = 100
    wt_oversold_l1 = RealParameter(low=-99, high=0, default=-53, space='buy', optimize=True, load=True)
    wt_oversold_l2 = -60
    wt_oversold_l3 = -75
