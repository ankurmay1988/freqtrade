...
class MC2Strategy(IStrategy):
    ...
    wt_overbought_l1 = IntParameter(low=40, high=99, default=53, space='sell', optimize=True, load=True)
    wt_overbought_l2 = 60
    wt_overbought_l3 = 100
    wt_oversold_l1 = IntParameter(low=-99, high=-40, default=-53, space='buy', optimize=True, load=True)
    wt_oversold_l2 = -60
    wt_oversold_l3 = -75
    mfi_level = IntParameter(low=-25, high=25, default=0, space='buy', optimize=True, load=True)
    vwap_level = IntParameter(low=-25, high=25, default=0, space='buy', optimize=True, load=True)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['vwap'] = dataframe['wt1'] - dataframe['wt2']
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        crosses = qtpylib.crossed_above(dataframe['wt1'], dataframe['wt2']) | qtpylib.crossed_below(dataframe['wt1'], dataframe['wt2'])
        check_mfi = dataframe['mfi'] > self.mfi_level.value
        check_vwap = dataframe['vwap'] > self.vwap_level.value
